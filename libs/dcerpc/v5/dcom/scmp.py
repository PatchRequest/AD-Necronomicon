...
from libs.dcerpc.v5.ndr import NDRENUM, NDRSTRUCT, NDRUNION
from libs.dcerpc.v5.dcomrt import PMInterfacePointer, INTERFACE, DCOMCALL, DCOMANSWER, IRemUnknown2
from libs.dcerpc.v5.dtypes import LONG, LONGLONG, ULONG, WSTR
...
class IVssSnapshotMgmt(IRemUnknown2):
    ...
    def QuerySnapshotsByVolume(self, volumeName, providerId = IID_ShadowCopyProvider):
        ...
        try:
            ...
            print(e)
            from libs.winregistry import hexdump
            data = e.get_packet()
            hexdump(data)
