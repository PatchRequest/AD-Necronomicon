...
from libs.dcerpc.v5.ndr import NDRSTRUCT, NDRENUM, NDRUniConformantVaryingArray
from libs.dcerpc.v5.dcomrt import DCOMCALL, DCOMANSWER, INTERFACE, PMInterfacePointer, IRemUnknown
from libs.dcerpc.v5.dcom.oaut import IDispatch, BSTR, VARIANT
from libs.dcerpc.v5.dtypes import INT, ULONG, LONG, BOOLEAN
