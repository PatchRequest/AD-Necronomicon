...
from six import b
from libs.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from libs.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG
from libs import system_errors, nt_errors
from libs.uuid import uuidtup_to_bin
from libs.dcerpc.v5.enum import Enum
from libs.dcerpc.v5.samr import OLD_LARGE_INTEGER
from libs.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from libs.dcerpc.v5.rpcrt import DCERPCException
from libs.structure import Structure
from libs import ntlm, crypto, LOG
import hmac
import hashlib
try:
...
from libs.dcerpc.v5.lsad import STRING
...
from libs.dcerpc.v5.samr import SAMPR_LOGON_HOURS
