...
from libs.uuid import uuidtup_to_bin, bin_to_string
from libs.dcerpc.v5 import transport
from libs.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRPOINTER, NDRUniConformantVaryingArray, NDRUniVaryingArray, \
    NDRUniConformantArray
from libs.dcerpc.v5.dtypes import UUID, LPBYTE, PUUID, ULONG, USHORT
from libs.structure import Structure
from libs.dcerpc.v5.ndr import NULL
