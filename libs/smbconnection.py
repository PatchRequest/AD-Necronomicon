...
from libs import smb, smb3, nmb, nt_errors,LOG
from libs.ntlm import compute_lmhash, compute_nthash
from libs.smb3structs import SMB2Packet, SMB2_DIALECT_002, SMB2_DIALECT_21, SMB2_DIALECT_30, GENERIC_ALL, FILE_SHARE_READ, \
...
class SMBConnection:
    ...
    def kerberosLogin(self, user, password, domain='', lmhash='', nthash='', aesKey='', kdcHost=None, TGT=None,
        ...
        from libs.krb5.kerberosv5 import KerberosError
